...
public class create_post extends BaseAdapter {

    public static String WebLink_Timeline = "https://travelbook-287802.nw.r.appspot.com/TimelineApi";
    ...
    create_post(Context context, ArrayList<String> Caption, ArrayList<Bitmap> photo_url, ArrayList<String> experience, ArrayList<String> hotel, ArrayList<String> flight, ArrayList<String> visa, ArrayList<String> from_location,ArrayList<String>  to_location){
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(view != null){
            ...
            view = li.inflate(R.layout.activity_create_post, viewGroup , false);
